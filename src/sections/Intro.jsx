                ...
                <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
                  <div className="text-center">
                    ...
                    <p className="max-w-xl mt-5 mx-auto text-xl text-gray-400">
                      I'm from Australia and I enjoy doing web dev. I like learning new things. I own a game site named Astroid, it's purpose is providing games that bypasses school firewalls and restrictions
                    </p>
